...
<template>
    <div class="flex flex-wrap justify-center">
        <div tabindex="0" class="button px-2 bg-green-500 hover:bg-green-600" @click="downloadImage(file)">
        ...
        <div tabindex="0" v-if="fileTypes[file.type].startsWith('image')" class="button px-2 bg-gray-400 hover:bg-gray-500" @click="copyImage(file, (success)=>{$emit('notify', success, success ? 'Image copied to clipboard' : 'Could not copy image to clipboard')});">
        ...
        <div tabindex="0" class="button px-2 bg-gray-400 hover:bg-gray-500" @click="copyLink(file, (success)=>{$emit('notify', success, success ? 'Link copied to clipboard' : 'Could not copy link')});">
